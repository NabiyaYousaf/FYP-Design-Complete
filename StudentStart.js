         ...
         screenOptions={{
            ...
            <Drawer.Screen name='stufeedback' component={StudentResult} 
              options={{
                ...
                headerTintColor:"#fff",
                title:"StudentResult",
                drawerIcon:props=><MaterialCommunityIcons name="note-multiple-outline" size={20} color="#fff" />
              }}
            />
            <Drawer.Screen name='stuprofile' component={StudentProfile} 
              options={{
                ...
                drawerIcon:props=><MaterialCommunityIcons name="account-clock" size={20} color="#fff" />
              }}
            />
             <Drawer.Screen name='logout' component={Logout} 
              options={{
                ...
                headerTintColor:"#fff",
                title:"Logout",
                drawerIcon:props=><MaterialCommunityIcons name="account-convert" size={20} color="#fff" />
              }}
            />
        </Drawer.Navigator>
